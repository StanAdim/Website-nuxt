                ...
                <div class="layout-bordered-item wow-outer">
                    <div class="layout-bordered-item-inner wow slideInUp">
                        ...
                        <ul class="list-0">
                            ...
                            <li><a class="link-default" href="#">PO BOX 70479 <br> Dar es salaam</a></li>
                        </ul>
                    </div>
                </div>
                <div class="layout-bordered-item wow-outer">
                ...
                <div class="row">
                    <div class="col-lg-9 cell-inner">
                        <div class="section-lg">
                            ...
                            <form class="rd-form rd-mailform" method="post" action="" data-form-output="form-output-global" autocomplete="off" data-form-type="contact">
                            <!-- @include('frontend.includes._alert')
                              
                            {!! Form::open(['route' => 'frontend.contact.store', 'class'=>'',''=>'', ''=>'contact', 'autocomplete'=>'off', 'validate' => true]) !!}
                            ...
                            <div class="row row-10">
                                <div class="col-md-6 wow-outer">
                                    <div class="form-wrap wow fadeSlideInUp">
                                        ...
                                        <input type="text" name="first_name" id="contact-first-name" data-constraints="@Required" class="form-input">
                                    </div>
                                </div>
                                <div class="col-md-6 wow-outer">
                                    <div class="form-wrap wow fadeSlideInUp">
                                        <label class="form-label-outside" for="contact-last-name">Last Name</label>
                                        <input type="text" name="last_name" id="contact-last-name" data-constraints="@Required" class="form-input">
                                    </div>
                                </div>
                                <div class="col-md-6 wow-outer">
                                    <div class="form-wrap wow fadeSlideInUp">
                                        <label class="form-label-outside" for="contact-email">E-mail</label>
                                        <input type="text" name="email" id="contact-email" data-constraints="@Email Required" class="form-input">
                                    </div>
                                </div>
                                <div class="col-md-6 wow-outer">
                                    <div class="form-wrap wow fadeSlideInUp">
                                        <label class="form-label-outside" for="contact-phone">Phone</label>
                                        <input type="text" name="phone" id="contact-phone" data-constraints="@Required" class="form-input">
                                    </div>
                                </div>
                                <div class="col-12 wow-outer">
                                    <div class="form-wrap wow fadeSlideInUp">
                                        <label class="form-label-outside" for="contact-message">Your Message</label>
                                        <textarea name="message" id="contact-message" data-constraints="@Required" class="form-input"></textarea>
                                    </div>
                                </div>
                            </div>
